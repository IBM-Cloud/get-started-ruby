...
This guide will take you through the steps to get started with a simple Ruby application in {{site.data.keyword.Bluemix}} and help you:
  * set up a development environment
  * download sample code
  * run locally
  * run on {{site.data.keyword.Bluemix}}, and
...
Edit the manifest.yml file and change the `name` from `GetStartedRuby` to your app name, <var class="keyword varname" data-hd-keyref="app_name">app_name</var>.
{: download}
